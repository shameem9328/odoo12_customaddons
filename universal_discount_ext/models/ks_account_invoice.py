...
class KsGlobalDiscountInvoice(models.Model):
    ...
    ks_policy_discount_account = fields.Text(compute='ks_verify_discount')
    ...
    def ks_verify_discount(self):
        for rec in self:
            ...
            rec.ks_policy_discount_account = rec.env['ir.config_parameter'].sudo().get_param('ks_policy_discount_account')
    ...
    def invoice_line_move_line_get(self):
        ...
        if self.ks_amount_discount > 0:
            ...
            if self.ks_policy_discount_account and (self.type == "out_invoice" or self.type == "out_refund"):
                ...
                dict = {
                    ...
                    'account_id': int(self.ks_policy_discount_account),
                    'invoice_id': self.id,
                }
                ks_res.append(dict)
